...
export const proposalCardCompatibility: Record<ProposalCardKind, readonly ProposalCardKind[]> = {
  ...
  server: ['agent', 'worker', 'query', 'profile', 'analysis', 'impact', 'risk', 'patch', 'monitor', 'parallel', 'diagram', 'split', 'decision', 'transform', 'review', 'validation', 'output'],
  agent: ['agent', 'worker', 'query', 'profile', 'analysis', 'impact', 'risk', 'patch', 'monitor', 'parallel', 'diagram', 'split', 'decision', 'transform', 'review', 'validation', 'output'],
  ...
  monitor: ['agent', 'worker', 'query', 'profile', 'analysis', 'impact', 'risk', 'patch', 'parallel', 'diagram', 'split', 'decision', 'validation', 'output'],
...
function compactGraph(payload: unknown) {
  ...
  if (graph.nodes.length > maximumNodes || graph.edges.length > maximumEdges) throw new Error('Agent request graph exceeds the GAME LAB safety limits')
