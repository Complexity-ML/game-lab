...
describe('fail-closed macOS update policy', () => {
  ...
  it('finds a packaged .app bundle without accepting a development executable', () => {
    expect(macApplicationBundle('/Applications/GAME LAB.app/Contents/MacOS/GAME LAB')).toBe('/Applications/GAME LAB.app')
  ...
  it('accepts a Developer ID Application identity with a team identifier, not ad-hoc signing', () => {
    expect(isDeveloperIdApplicationSignature('Authority=Developer ID Application: GAME LAB (ABCDE12345)\nTeamIdentifier=ABCDE12345\n')).toBe(true)
