...
product that can be ingested into DataHub and inspected by GAME LAB.
...
1. Open **Settings → DataHub** in GAME LAB.
...
GAME LAB receives schemas, profiles and upstream/downstream lineage through its
...
the `sam_mart` views and GAME LAB workflow. Hash or otherwise pseudonymize the
