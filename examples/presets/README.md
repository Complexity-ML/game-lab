# Judge-readable GAME LAB presets

These synthetic examples match the optional canvases under **Settings → Examples**. GAME LAB still starts with a blank workbench; loading a preset is always explicit.
