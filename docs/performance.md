...
GAME LAB targets a production workbench of **300 cards and 420 edges** on a current Apple Silicon laptop. The interaction target is a 60 Hz frame budget (16.7 ms) for pan, zoom and card dragging.
