...
const groups = [
  {
    ...
    description: 'Owner of GitHub Copilot licensing and usage evidence for the GAME LAB demo.',
  },
  {
    id: 'procurement',
    urn: 'urn:li:corpGroup:procurement',
    name: 'Procurement',
    description: 'Owner of contract and renewal evidence for the GAME LAB demo.',
  },
]
