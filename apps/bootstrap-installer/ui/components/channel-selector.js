...
export function createChannelSelector() {
  ...
  const description = createElement('small', { text: 'Latest published GAME LAB release · recommended' })
  const element = createElement('section', { className: 'channel-selector', attributes: { 'aria-label': 'GAME LAB source channel' } }, [
  ...
  function setValue(next, notify = false) {
    ...
    description.textContent = value === 'main'
      ...
      : 'Latest published GAME LAB release · recommended'
