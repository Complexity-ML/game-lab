...
import { acyclicFlowAtom, cardContractsAtom, edgeIntegrityAtom, gameActionSafetyAtom, gameBridgeAtom, pipelinePresenceAtom, pipelineTerminalsAtom } from './atoms'
 ...
 * safe graph transaction. Orphaned workflow cards do block the transaction:
