import { Gamepad2, LoaderCircle, Pause, Play, Settings, Square } from 'lucide-react'
...
export function AppHeader({ agentBusy, cardCount, onOpenSettings, onPause, onPlay, onStop, playerState, projectTitle, reviewPending, saveState }: AppHeaderProps) {
  ...
  return <header className="topbar">
    <div className="brand"><span className="brand-mark"><Gamepad2 size={18} /></span><div><strong>GAME LAB</strong><small>{t('appSubtitle')}</small></div></div>
