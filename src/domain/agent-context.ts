...
export function buildPipelineAgentRequest(input: AgentContextInput & {
  ...
  return {
    ...
    guardrails: [
      "Return only a contract-valid proposal and never claim execution; an autonomous low-risk gameplay proposal may contain just one game_action",
      ...
      "For Minecraft, use only the structured inventory, nearbyBlocks, localMap and entity IDs in gameRuntime; choose routes that avoid localMap hazard, blocked and drop cells, and never invent a block, recipe, item or coordinate",
